...
def getting_lemmas(emb_type, dict_vad, dict_sub, word2vec):
	...
	words_lexicons = dict.fromkeys(list(set(dict_vad.keys()).union(set(dict_sub.keys()))), 0)
...
def filling_embeddings(word2idx, word2vec, vocabulary, dict_vad, dict_sub, emb_type, type_matrix_emb, type_lex):
	...
	print('size_outpt_class: ', len(size_output))
	...
	print('Num ' + type_lex + ': ', count_sub, ', size: ', np.shape(y_sub))
