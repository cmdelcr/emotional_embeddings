...
precision = precision_score(y_true=y_test, y_pred=pred, labels=[0, 1], pos_label=1, average='macro')
recall = recall_score(y_true=y_test, y_pred=pred, labels=[0, 1], pos_label=1, average='macro')
f1 = f1_score(y_true=y_test, y_pred=pred, labels=[0, 1], pos_label=1, average='macro')
